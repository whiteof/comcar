 ...
 * @since       1.6
 */
class WcatalogViewProducts extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		WcatalogHelper::addSubmenu('products');
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_WCATALOG_MANAGER_PRODUCTS'), 'products.png');
		...
		//JToolbarHelper::help('JHELP_COMPONENTS_WCATALOG_PRODUCTS');

		JHtmlSidebar::setAction('index.php?option=com_wcatalog&view=products');
/*
...
*/
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.price' => JText::_('COM_WCATALOG_PRICE'),
			'b.title' => JText::_('COM_WCATALOG_CATEGORY'),
