...
<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="category" width="100%" style="padding: 10px 30px 10px 30px;" cellpadding="0px" cellspacing="0px">
			...
			<tr class="cat-list-row<?php echo $i % 2; ?>">
				...
				<?php if (in_array($article->access, $this->user->getAuthorisedViewLevels())) : ?>
					...
					<td class="list-title">
						...
						<a href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($article->slug, $article->catid)); ?>" style="display: block; margin-top: 10px; text-transform: lowercase;">
							<?php echo JText::_('RUS_TEXT_READ_MORE'); ?>
						</a>
					</td>
