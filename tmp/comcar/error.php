	...
	<div id="all">
		...
		<div id="header">
					...
					<div class="logoheader">
						...
						<ul class="skiplinks">
							<li><a href="#wrapper2" class="u2"><?php echo JText::_('TPL_COMCAR_SKIP_TO_ERROR_CONTENT'); ?></a></li>
							<li><a href="#nav" class="u2"><?php echo JText::_('TPL_COMCAR_ERROR_JUMP_TO_NAV'); ?></a></li>
		...
		<div id="contentarea2" >
				...
				<h2 class="unseen"><?php echo JText::_('TPL_COMCAR_NAVIGATION'); ?></h2>
			...
			<div id="errorboxbody">
						<h2><?php echo JText::_('JERROR_AN_ERROR_HAS_OCCURRED'); ?><br />
								...
								<?php if (JModuleHelper::getModule('search')) : ?>
									<div id="searchbox">
									<h3 class="unseen"><?php echo JText::_('TPL_COMCAR_SEARCH'); ?></h3>
			...
			<div id="footer-sub">
                                ...
                                <div id="footer">
                                        <p>
                                                <?php echo JText::_('TPL_COMCAR_POWERED_BY');?> <a href="http://www.joomla.org/">Joomla!&#174;</a>
                                        </p>
